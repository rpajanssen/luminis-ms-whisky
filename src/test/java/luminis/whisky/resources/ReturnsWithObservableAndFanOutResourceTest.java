...
public class ReturnsWithObservableAndFanOutResourceTest {
    ...
    private ReturnsWithObservableAndFanOutResource underTest;
    ...
    public void setup() throws DyingServiceException {
        ...
        underTest = new ReturnsWithObservableAndFanOutResource(consulServiceUrlFinder, metrics) {
            @Override
